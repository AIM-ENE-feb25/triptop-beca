...
### Reden van afwijzigng

Na het beginnen aan het coderen hebben we ervoor gekozen om geen API Gateway te implementeren. Het maken van een API Gateway kost veel tijd en achteraf merkten we dat het niet binnen de scope van het project valt. Hierdoor hebben we onze prioriteiten gezet op het maken van de prototypes zonder API Gateway.
